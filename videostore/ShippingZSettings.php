...
define("SHIPPINGZSETTINGS_VERSION","2.0.0.47809");
...
define("SHIPPING_ACCESS_TOKEN","3REDU43drazeqe9aj8Br38rEPhUxACe");  // See steps above to set this -- REQUIRED !
...
define("ZENCART_SHIPPED_STATUS_SET_TO_STATUS_3_DELIVERED",1);//Default is 1
...
define("OSCOMMERCE_RETRIEVE_ORDER_STATUS_2_PROCESSING",8);
define("OSCOMMERCE_RETRIEVE_ORDER_STATUS_3_DELIVERED",22);
...
# BOTH STATUS 1 (Pending) and STATUS 2 (Processing) will be
# set to STATUS 3 (Delivered)
define("OSCOMMERCE_SHIPPED_STATUS_SET_TO_STATUS_3_DELIVERED",1);//Default is 1
...
define("CRELOADED_SHIPPED_STATUS_SET_TO_STATUS_3_DELIVERED",1);//Default 1
...
# To retrieve statuses in addition to those here, see the section below "Adding New Order Statuses"
#
#    The setting QUEUED below will retrieve both QUEUED and Pre_Authorized orders (if set to 1).
...
define("XCART_SHIPPED_STATUS_SET_TO_STATUS_4_COMPLETE",1);//Defaults 1
...
define("UBERCART_SHIPPED_STATUS_SET_TO_STATUS_4_COMPLETE",1);//Defaults 1
...
# STATUS 1 (Pending), STATUS 2 (Payment Receive) and STATUS 3 (processing) will be
# set to STATUS 4 (Complete)
define("DRUPAL_SHIPPED_STATUS_SET_TO_STATUS_4_COMPLETE",1);//Defaults 1
################################################ Only for CS-Cart Users ############################################
#
# To retrieve statuses in addition to those here, see the section below "Adding New Order Statuses"
#
...
define("OPENCART_RETRIEVE_ORDER_STATUS_1_PENDING",0);
define("OPENCART_RETRIEVE_ORDER_STATUS_2_PROCESSING",1);
define("OPENCART_RETRIEVE_ORDER_STATUS_3_SHIPPED",0);
