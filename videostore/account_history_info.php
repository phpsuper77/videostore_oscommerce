...
<?php
  $statuses_query = tep_db_query("select os.orders_status_name, osh.date_added, osh.comments from " . TABLE_ORDERS_STATUS . " os, " . TABLE_ORDERS_STATUS_HISTORY . " osh where osh.orders_id = '" . (int)$HTTP_GET_VARS['order_id'] . "' and osh.orders_status_id = os.orders_status_id and os.language_id = '" . (int)$languages_id . "' and customer_notified='1' order by osh.date_added");
...
?>								
								<td class="main" align="right"><a target="_new" href="invoice.php?oID=<?=$HTTP_GET_VARS['order_id']?>"><img src="images/print_invoice.gif" border="0" alt="Print Invoice" title="Print Invoice" /></a>&nbsp;
<?
	if ($trackLink) {
		//echo '<a href="' . $trackLink . '"><b><img src="images/track_shipment.gif" border="0" alt="Track this Shipment" title="Track this Shipment" /></b></a>';
		}
	else {
