...
if (trim($productList) == '') die("No items to send to Tampa!");
...
if (trim($productInfo) == "") die("No products to send to Tampa!");
...
$url = "http://remote.travelvideostore.com:55555";
...
$comments = "Sent to Tampa Fulfillment Center " . date("m-d-Y H:i:s") ." - Order ID=" .$oID." - ".$carrier." ".$carry_type;
