...
<form action="" method="POST">
	...
	<!--select name="carry">
		...
		<option value="UPSMI">UPS Mail Innovations</option>
		<option value="UPS">UPS</option>
		<option value="WHS">WAREHOUSE Internal</option>
	</select-->
	<select name="carry">
		<option value=""></option>
	...
	<!--select name="carry_type">
		...
		<option value="Media Mail">US Mail Single Item Flat</option>
		<option value="Global Priority Mail">US Mail Global Priority Mail</option>
		<option value="MIFC">UPS Mail Innovations w/tracking</option>
		...
		<option value="Internal">Internal Pickup - Critics Choice-Infinity</option>
	</select-->
	<select name="carry_type">
		<option value=""></option>
		<option value="First Class">US Mail First Class</option>
...
//}
	...
	$totalNum = $totalNum+$qty;
               ...
               if ($product[has_rights] == "1") {$rights = " - Includes Limited Public Performance Rights";} else {$rights = " - Home Use Only";} 
		...
		$productInfo .= '
			...
			<MediaDefinitionProduct type="'.$allied[product_media_definition].'">
                			...
                			<LabelField number="3">'.$product[products_upc].'</LabelField>
                                                             <LabelField number="4">'.$title.''.$rights.'</LabelField>
...
foreach($pos as $key=>$value) {
	...
	mysql_query("update orders_products set date_sent_to_allied='".$sent."', is_allied=1, date_shipped_checkbox=1, fulfilled_by='CHI' where orders_products_id='".$value."'");
...
//$comments = "Sent to allied on " . date("m-d-Y H:i:s") ." - SentOrderID=" .$oID ;
...
$comments = "Sent to Chicago Fulfillment Center " . date("m-d-Y H:i:s") ." - Order ID=" .$oID." - ".$carrier." ".$carry_type;
