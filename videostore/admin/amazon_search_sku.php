...
<script>
	function RunSelect(sku, price, qty, cnt){
		//alert(sku+"---"+price+"---"+qty+"----"+cnt);
		window.opener.document.getElementById('products_sku_'+cnt).value=sku;
		window.opener.document.getElementById('products_db_price_'+cnt).value=price;
		window.opener.document.getElementById('products_qty_stock_'+cnt).value=qty;
		window.close();
	}
</script>

	<form action="amazon_search_sku.php" method="get">
