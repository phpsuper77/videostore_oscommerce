		...
		if (is_array($new_vendors)) {
				foreach($new_vendors as $key=>$value)
				{
					if (@array_search($value, $old_current) === false) 
						tep_db_query("insert into ".TABLE_PRODUCTS_TO_VENDORS." (products_id,vendors_id) values ('" . (int)$products_id . "', '" . $value. "')");
				}
		}
...
<!-- // BOF: MaxiDVD Added for Ulimited Images Pack! -->
		...
		function create_window(image, width, height) {
			...
			// Set the URL:
			var url = "viewfile.php?image=" + image;
          ...
          <tr>
           ...
           <td class="dataTableRow" valign="top"><span class="smallText"><?php echo '<table border="0" cellspacing="0" cellpadding="0"><tr><td class="main">' . tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp; </td><td class="dataTableRow">' . tep_draw_textarea_field('products_image', 'soft', '70', '2', $pInfo->products_image) . tep_draw_hidden_field('products_previous_image', $pInfo->products_image) . '</td></tr></table>';
		   	...
		   	$tempimg=DIR_WS_CATALOG_IMAGES . $pInfo->products_image;
			$image_tp_size = getimagesize ($tempimg);
			$image_tp = urlencode($tempimg);
			$image_tp_name = $pInfo->products_image;
		   	$link_tp='<a style="font-size: 13px;" title="Click to Preview" href="javascript:create_window(\'' . $image_tp . '\',' . $image_tp_size[0] . ',' . $image_tp_size[1] . ')">' . $image_tp_name . '</a>';
		   
           echo tep_draw_separator('pixel_trans.gif', '24', '17" align="left') . $link_tp . tep_draw_hidden_field('products_previous_image', $pInfo->products_image) . '<br>'. tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="unlink_image" value="yes">' . TEXT_PRODUCTS_IMAGE_REMOVE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="delete_image" value="yes">' . TEXT_PRODUCTS_IMAGE_DELETE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '1', '42'); ?></span></td>
          </tr>
          <tr>
		   ...
		   $tempimg=DIR_WS_CATALOG_IMAGES . $pInfo->products_image_med;
			$image_tp_size = getimagesize ($tempimg);
			$image_tp = urlencode($tempimg);
			$image_tp_name = $pInfo->products_image_med;
			$link_tp='<a style="font-size: 13px;" title="Click to Preview" href="javascript:create_window(\'' . $image_tp . '\',' . $image_tp_size[0] . ',' . $image_tp_size[1] . ')">' . $image_tp_name . '</a>';
			
           echo tep_draw_separator('pixel_trans.gif', '24', '17" align="left') . $link_tp . tep_draw_hidden_field('products_previous_image_med', $pInfo->products_image_med) . '<br>'. tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="unlink_image_med" value="yes">' . TEXT_PRODUCTS_IMAGE_REMOVE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="delete_image_med" value="yes">' . TEXT_PRODUCTS_IMAGE_DELETE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '1', '42'); ?></span></td>
          </tr>
          <tr>
		   ...
		   $tempimg=DIR_WS_CATALOG_IMAGES . $pInfo->products_image_lrg;
			$image_tp_size = getimagesize ($tempimg);
			$image_tp = urlencode($tempimg);
			$image_tp_name = $pInfo->products_image_lrg;
			$link_tp='<a style="font-size: 13px;" title="Click to Preview" href="javascript:create_window(\'' . $image_tp . '\',' . $image_tp_size[0] . ',' . $image_tp_size[1] . ')">' . $image_tp_name . '</a>';
			
           echo tep_draw_separator('pixel_trans.gif', '24', '17" align="left') . $link_tp . tep_draw_hidden_field('products_previous_image_lrg', $pInfo->products_image_lrg) . '<br>'. tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="unlink_image_lrg" value="yes">' . TEXT_PRODUCTS_IMAGE_REMOVE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="delete_image_lrg" value="yes">' . TEXT_PRODUCTS_IMAGE_DELETE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '1', '42'); ?></span></td>
          </tr>
          <tr>
		   ...
		   $tempimg=DIR_WS_CATALOG_IMAGES . $pInfo->cover_image;
			$image_tp_size = getimagesize ($tempimg);
			$image_tp = urlencode($tempimg);
			$image_tp_name = $pInfo->cover_image;
			$link_tp='<a style="font-size: 13px;" title="Click to Preview" href="javascript:create_window(\'' . $image_tp . '\',' . $image_tp_size[0] . ',' . $image_tp_size[1] . ')">' . $image_tp_name . '</a>';
			
           echo tep_draw_separator('pixel_trans.gif', '24', '17" align="left') . $link_tp . tep_draw_hidden_field('previous_cover_image', $pInfo->cover_image) . '<br>'. tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="unlink_cover_image" value="yes">' . TEXT_PRODUCTS_IMAGE_REMOVE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="delete_cover_image" value="yes">' . TEXT_PRODUCTS_IMAGE_DELETE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '1', '42'); ?></span></td>
          </tr>
