...
<!-- // BOF: MaxiDVD Added for Ulimited Images Pack! -->
          ...
          <tr>
           ...
           echo tep_draw_separator('pixel_trans.gif', '24', '17" align="left') . $pInfo->cover_image . tep_image(DIR_WS_CATALOG_IMAGES . $pInfo->cover_image, $pInfo->cover_image, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="left" hspace="0" vspace="5"') . tep_draw_hidden_field('previous_cover_image', $pInfo->cover_image) . '<br>'. tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="unlink_cover_image" value="yes">' . TEXT_PRODUCTS_IMAGE_REMOVE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '5', '15') . '&nbsp;<input type="checkbox" name="delete_cover_image" value="yes">' . TEXT_PRODUCTS_IMAGE_DELETE_SHORT . '<br>' . tep_draw_separator('pixel_trans.gif', '1', '42'); ?></span></td>
          </tr>
