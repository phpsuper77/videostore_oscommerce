...
// purchaseorders_1_4 end
	...
	$iswholesale = tep_db_prepare_input($HTTP_POST_VARS['iswholesale']);
	$distribution_percentage = tep_db_prepare_input($HTTP_POST_VARS['distribution_percentage']);
	$nondistribution_percentage = tep_db_prepare_input($HTTP_POST_VARS['nondistribution_percentage']);
	$disc1 = tep_db_prepare_input($HTTP_POST_VARS['disc1']);
	$disc2 = tep_db_prepare_input($HTTP_POST_VARS['disc2']);
	 $shipping1 = tep_db_prepare_input($HTTP_POST_VARS['shipping1']);
	$shipping2 = tep_db_prepare_input($HTTP_POST_VARS['shipping2']);
      ...
      if ($error == false) {
        ...
        $sql_data_array = array('customers_firstname' => $customers_firstname,
				...
				'shipping1' => $shipping1,	
				'shipping2' => $shipping2,	
				'nondistribution_percentage' => $nondistribution_percentage,
...
<!-- purchaseorders_1_4 end -->
      ...
      <tr>
        <td class="formAreaTitle">Wholesale Options</td>
      </tr>
      <tr>
        <td class="formArea"><table border="0" cellspacing="2" cellpadding="2">
          <tr>
...
<?php
        if($processed == true)
          ...
          echo tep_draw_hidden_field('iswholesale');
  			...
  			{
          echo tep_draw_radio_field('iswholesale', '1', false, $cInfo->iswholesale) . '&nbsp;&nbsp;' . TEXT_YES . '&nbsp;&nbsp;' . tep_draw_radio_field('iswholesale', '0', false, $cInfo->iswholesale) . '&nbsp;&nbsp;' . TEXT_NO;
        } // if - else
?>
	    </td>
	  </tr>
...
<?php
        if($processed == true)
          ...
          echo tep_draw_hidden_field('distribution_percentage');
  			...
  			{	
	echo tep_draw_input_field('distribution_percentage', $cInfo->distribution_percentage, 'id="id1" maxlength="20" size="10"');
        } // if - else
?>
	    </td>
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
?>
	<select name="disc1"><option value="1" <?=$status1?>>List Price</option><option value="2" <?=$status2?>>Sale Price</option></select>
<?	
        } // if - else
?>
	    </td>
...
?>
	<input type="checkbox" name="shipping1" value="1" <? echo ($cInfo->shipping1)?'checked':''?>/>
<?
        } // if - else
?>
...
<?php
        if($processed == true)
          ...
          echo tep_draw_hidden_field('nondistribution_percentage');
  			...
  			{	
	echo tep_draw_input_field('nondistribution_percentage', $cInfo->nondistribution_percentage, 'id="id2" maxlength="10" size="10"');
        } // if - else
?>
	    </td>
	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
?>
	<select name="disc2"><option value="1" <?=$status1?>>List Price</option><option value="2" <?=$status2?>>Sale Price</option></select>
<?	
        } // if - else
?>
	    </td>
...
<?php
        if($processed == true)
          ...
          echo tep_draw_hidden_field('shipping2');
  			...
  			{	
?>
	<input type="checkbox" name="shipping2" value="1" <? echo ($cInfo->shipping2)?'checked':''?>/>
<?
        } // if - else
?>
...
?>
                <td class="dataTableContent"><?=$customers['entry_company']?></td>
