  ...
  if (tep_not_null($action)) {
    switch ($action) {
      ...
      case 'save':
		...
		//changed by tamil
        $distributors_description = tep_db_prepare_input($HTTP_POST_VARS['distributors_description']);

        $sql_data_array = array('distributors_name' => $distributors_name,'distributors_description' => $distributors_description);
...
<?php
  $distributors_query_raw = "select distributors_id, distributors_name,distributors_description, distributors_image, date_added, last_modified from " . TABLE_DISTRIBUTORS . " order by distributors_name";
...
<?php
  ...
  switch ($action) {
    case 'new':
      ...
      $contents[] = array('text' => '<br>' . 'Distributors Description :' . '<br>' . tep_draw_textarea_field('distributors_description', 'soft', '40', '10'));
    ...
    case 'edit':
      ...
      $contents[] = array('text' => '<br>' . 'Distributors Description :' . '<br>' . tep_draw_textarea_field('distributors_description', 'soft', '40', '10',$mInfo->distributors_description));
