...
$pdf->MultiCell(18, 5, 'Total Accrued', 1, 'C', 1);
$pdf->setXY($colProd5pos, 35 + $i * 10);
$pdf->MultiCell(18, 10, 'Total Sales', 1, 'C', 1);
...
while ($products=tep_db_fetch_array($products_query_jim))
    ...
    if ($bDetailMode)
        ...
        if (($curProdModel != $rowProdModel) && ($curProdModel > ""))
            ...
            // print our totals
            $pdf->setXY($colProd1pos, $top_table + $i * 10);
            $pdf->Cell(40, 10, $curProdModel, 1, 1, 'L');
        ...
        $curTot+=($products['products_item_cost'] * $products['products_quantity']);
        ...
        $curTotPG+=($products['products_item_cost'] * $products['products_quantity']);
...
if (!$bDetailMode)
    ...
    // print our totals
    $pdf->setXY($colProd1pos, $top_table + $i * 10);
    $pdf->Cell(40, 10, $rowProdModel, 1, 1, 'L');
