...
$iterator = 0;
 ...
 $pdf->Bookmark("Independent Films",null,$percentTop);
...
$pdf->MultiCell(68,3, $products[products_name_prefix].' '.$products[products_name].' '.$products[products_name_suffix].' '.$release, 0, 1,'J');
...
$model = eregi_replace("/-PDVD-/", "-PAL-", $model);
$model = eregi_replace("/-DVD-/", "-NTSC-", $model);

		$pdf->Text($UPCBlock,58+$fromUPC+$percentTop, "Model: ".$model);
               }
...
$comm = eregi("&nbsp;", "", $comm);
$comm = eregi("--", "-", $comm);*/
$comm = substr($comm, 0, 440);

$pdf->MultiCell(68,2.5, $comm."...", 0,'J');
