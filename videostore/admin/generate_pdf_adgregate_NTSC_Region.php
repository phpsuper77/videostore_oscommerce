...
$pdf->AddPage();	
$pdf->Image($abs_url.'../images/finalcover.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/finalpage2.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/finalpage3.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/finalpage4.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALArcadia2010releases.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALSeasonedTraveler_ad.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALEquitrekking_ad.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALCitiesoftheWorld.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALLOAC.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/PTABrochureA4.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINAL7DYad.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALVPGcatalog1.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALTMTcatalog1.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALNPMcatalog1.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALOTTcatalog-1.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALGRKcatalog.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALGOWcatalog1.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALGOTcatalog1.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALESOcatalog1.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/FINALCDGcatalog1.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/NWGcatalog.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/BSPcatalog.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/DMcatalog.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/lsflyer.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/exphorizoncatalog.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/exphorizoncatalog.jpg',0,0,210);

$pdf->AddPage();	
$pdf->Image($abs_url.'../images/GTRcatalog.jpg',0,0,210);
$pdf->AddPage();
$pdf->Text(185,295,'Page '.$pdf->PageNo().' of '.ceil($total));
$pdf->SetFont('Arial','I',9);
$pdf->Text(5,295,'TravelVideoStore Distribution Catalog '.date("m/d/Y").'  '.$products[distributors_name]);
$pdf->SetFont('Arial','',9);
...
$iterator++;
$next_distributors_name = $current_distributors_name;
$current_distributors_name = $products[distributors_name];
...
if (!empty($products[series_name])) {
	...
	$pdf->Text(38+$SeriesBlock,8+$percentTop, $products[series_name]);
                $seriesadd= 4;
	$pdf->SetFont('Arial','',9);
}
if (is_file('../images/'.$products[products_image_med]))
...
$pdf->setY($fromTop+$percentTop+$seriesadd);
$pdf->SetFont('Arial','B',10);

if (!empty($products[products_release_date])) 
	$release = '('.$products[products_release_date].')';

$pdf->MultiCell(63,3, $products[products_name_prefix].' '.$products[products_name].' '.$products[products_name_suffix].' '.$release, 0, 1,'J');
...
$comm = preg_replace("/<p>/i", " ", $comm);
$comm = preg_replace("/</p>/i", "", $comm);
$comm = preg_replace("/</P>/i", "", $comm);
$comm = preg_replace("/</br>/i", "", $comm);
$comm = preg_replace("/<br>/i", " ", $comm);
$comm = preg_replace("/\r/i", "", $comm); 
$comm = preg_replace("/\n/i", "", $comm);
$comm = preg_replace("/&nbsp;/i", " ", $comm);
$comm = preg_replace("/--/i", "-", $comm);$comm = substr($comm, 0, 250);

$pdf->MultiCell(63,3, $comm."...", 0,'J');
...
if ($current_distributors_name!=$next_distributors_name) $pdf->Bookmark($products[distributors_name],null,$percentTop);
