...
$pdf->MultiCell(63,3, $products[products_prefix].' '.$products[products_name].' '.$products[products_suffix].' '.$release, 0, 1,'J');
...
$comm = eregi_replace("<p>", " ", $comm);
$comm = eregi_replace("</p>", "", $comm);
$comm = eregi_replace("</P>", "", $comm);
$comm = eregi_replace("</br>", "", $comm);
$comm = eregi_replace("<br>", " ", $comm);
$comm = eregi_replace("\r", "", $comm); 
$comm = eregi_replace("\n", "", $comm);
$comm = eregi_replace("&nbsp;", " ", $comm);
$comm = eregi_replace("--", "-", $comm);$comm = substr($comm, 0, 250);
