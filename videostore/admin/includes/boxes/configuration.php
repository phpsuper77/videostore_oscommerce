...
<?php
  ...
  if ($selected_box == 'configuration') {
    ...
    while ($configuration_groups = tep_db_fetch_array($configuration_groups_query)) {
      ...
      $cfg_groups .= '<a href="' . tep_href_link('description_generation.php', '', 'NONSSL') . '" class="menuBoxContentLink">Description Scrubing</a><br>';
      $cfg_groups .= '<a onclick="if (confirm(\'Do not forget to make a copy of \nproduct_to_category.db, please.\')) window.open(\'' . tep_href_link('prod_to_cat.php', '', 'NONSSL') . '\');" href="#" class="menuBoxContentLink"><b style="color:red;">Catalogue Regeneration</b></a><BR>';
