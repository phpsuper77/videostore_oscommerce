...
//echo "<hr><b>".$tmp_query . " AND o.date_purchased >= '" . tep_db_input(date("Y-m-d\TH:i:s", $this->startDates[$i])) . "' AND o.date_purchased < '" . tep_db_input(date("Y-m-d\TH:i:s", $this->endDates[$i])) . "'</b><hr>";
        ...
        switch ($this->mode) {
          ...
          case '5':
            ...
            for ($i = 0; $i < $this->size; $i++) {
//echo "<hr/>".$tmp_query . " AND o.date_purchased >= '" . tep_db_input(date("Y-m-d\TH:i:s", $this->startDates[$i])) . "' AND o.date_purchased < '" . tep_db_input(date("Y-m-d\TH:i:s", $this->endDates[$i])) . "'";
              $report_query = tep_db_query($tmp_query . " AND o.date_purchased >= '" . tep_db_input(date("Y-m-d\TH:i:s", $this->startDates[$i])) . "' AND o.date_purchased < '" . tep_db_input(date("Y-m-d\TH:i:s", $this->endDates[$i])) . "'");
        $report = tep_db_fetch_array($report_query);
