...
// Output a separator either through whitespace, or with an image
  ...
  function tep_draw_separator_80($image = 'pixel_black.gif', $width = '50%', $height = '1') {
    return tep_image(DIR_WS_IMAGES . $image, '', $width, $height);
  }
...
////
// Output a form pull down menu - VENDORS
  function tep_draw_pull_down_menu_vendors($name, $values, $default = '', $parameters = '', $required = false) {
    $field = '<select name="' . tep_output_string($name) . '" MULTIPLE';
