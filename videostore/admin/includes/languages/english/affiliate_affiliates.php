...
define('ENTRY_AFFILIATE_LOGO','Affiliate Logo'); //ADDED NEWLY
define('ENTRY_AFFILIATE_DISPLAY_LOGO','Logo Status'); //ADDED NEWLY
define('ENTRY_AFFILIATE_COUPON','Coupon ID'); //ADDED NEWLY
define('ENTRY_AFFILIATE_COUPON_BOX','Show Coupon Box'); //ADDED NEWLY
