...
define('TEXT_PRODUCTS_IMAGE_NOTE','Thumbnail Image:<small><br>Image used in<br><u>Product Listings</u><small>');
define('TEXT_PRODUCTS_IMAGE_MEDIUM', 'Medium Image:<br><small>Image used in<br><u>Product Description</u> page.</small>');
define('TEXT_PRODUCTS_IMAGE_LARGE', 'Full Size Image:<br><small>Image used in<br><u>Pop-up Window</u> page.</small>');
...
define('HEADING_TITLE_SEARCH', 'Catergory Search:');
...
define('TEXT_PRODUCTS_PRODUCER', 'Producer:');
define('TEXT_PRODUCTS_SERIES', 'Series:');
define('TEXT_PRODUCTS_NAME', 'Products Title Main:');
define('TEXT_PRODUCTS_NAME_PREFIX', 'Products Title Prefix:');
define('TEXT_PRODUCTS_NAME_SUFFIX', 'Products Title Suffix:');
...
define('TEXT_EDIT_CATEGORIES_HEADING_TITLE', 'Category Page Title');
define('TEXT_EDIT_CATEGORIES_DESCRIPTION', 'Category Description - HTML OK');
...
define('TEXT_VENDORS_LIST','Vendors:');
