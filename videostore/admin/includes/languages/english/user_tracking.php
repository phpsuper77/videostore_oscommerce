...
define('TEXT_NUMBER_OF_CUSTOMERS', 'Total number of visitors: ');
define('TEXT_NUMBER_OF_PAGES', 'There have been %s page views in this 24 hour period. ');
...
define('TEXT_PURGE_ALL', ' from NOW. ');
define('TEXT_BEWAREDELETE', 'BEWARE!! - THIS DELETES ALL DATA !!!.');
...
define('TEXT_DELETE_OK', 'All found records are deleted');
define('TEXT_DELETE_IP_OK_1', 'Records of IP ');
define('TEXT_DELETE_IP_OK_2', ' are deleted.');
define('TEXT_DELETE_NOIP', 'Delete all records without session ID ');
define('TEXT_DELETE_NOW', 'DELETE NOW');
define('TEXT_DELETE_SESSION', 'Delete Session');
define('TEXT_VIEW_SESSION', 'View Session');
