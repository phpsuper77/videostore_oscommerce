...
define('HINT_UPDATE_TO_CC', '<span style="color: red;">Aviso: </span>Fije el método del pago a la "tarjeta de crédito" para demostrar automáticamente los otros campos (e.g. Tipo De la Tarjeta De Crédito, Dueño, Número, Expira).');
