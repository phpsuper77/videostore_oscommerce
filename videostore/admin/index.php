...
*/
  ...
  $cat = array(array('title' => BOX_HEADING_CONFIGURATION,
               ...
               array('title' => 'Feed files',
                     'image' => 'affiliate.gif',
                     'href' => tep_href_link('feedfiles.php', 'selected_box=froogle'),
                     'children' => array(array('title' => 'Froogle', 'link' => tep_href_link('froogletxtfile.php', '')))),
  		...
  		array('title' => 'Vendors',
                     ...
                     'children' => array(array('title' => 'Prods/Vendors Map', 'link' => tep_href_link('prods_by_vendor.php', '')))),
					 
		   array('title' => 'Vouchers/Coupons',
                     'image' => 'coupons.gif',
                     'href' => tep_href_link(FILENAME_COUPON_ADMIN, 'selected_box=gv_admin'),
                     'children' => array(array('title' => 'Gift Vouchers', 'link' => tep_href_link(FILENAME_GV_SENT, 'selected_box=gv_admin')),
                                  array('title' => 'Redeem Report', 'link' => tep_href_link('redeem_report.php', 'selected_box=gv_admin')))));
