...
<tr>
		<td class="smalltext"><b><?php echo Referral; ?></b></td>
		<td class="smalltext"><a href="<?php echo $order->info['customers_referer_url'];  ?>" target="_blank"><?php echo $order->info['customers_referer_url']; ?></a></td>
               </tr>
...
<!--- ORDER SEARCH -->
				...
				<?php
					$criteria_value = array(1=>"Billing Address",2=>"Shipping Address",3=>"Products",4=>"Payment Method",5=>"Comments",6=>"Shipping Method");
...
<?php
	...
	//ORDER SEARCH STRING
	  if (isset($HTTP_GET_VARS['searchstring']) && ($HTTP_GET_VARS['searchstring'] <> '')) {
		...
		if ($criteria == 1) {
			$orders_query_raw = "select o.orders_id, o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from orders o left join orders_total ot on (o.orders_id = ot.orders_id), orders_status s where (o.billing_name like '%". $search_string ."%' or o.billing_company like '%". $search_string ."%' or o.billing_country like '%". $search_string ."%' or o.billing_state like '%". $search_string ."%' or o.billing_postcode like '%". $search_string ."%' or o.billing_city like '%". $search_string ."%' or o.billing_suburb like '%". $search_string ."%' or o.billing_street_address like '%". $search_string ."%') and o.orders_status = s.orders_status_id and s.language_id = '1' and ot.class = 'ot_total' and ot.orders_id = o.orders_id order by o.orders_id DESC ";
		}
		elseif ($criteria == 2) {
			$orders_query_raw = "select o.orders_id, o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from orders o left join orders_total ot on (o.orders_id = ot.orders_id), orders_status s where (o.delivery_name like '%". $search_string ."%' or o.delivery_company like '%". $search_string ."%' or o.delivery_street_address like '%". $search_string ."%' or o.delivery_suburb like '%". $search_string ."%' or o.delivery_city like '%". $search_string ."%' or o.delivery_postcode like '%". $search_string ."%' or o.delivery_state like '%". $search_string ."%' or o.delivery_country like '%". $search_string ."%') and o.orders_status = s.orders_status_id and s.language_id = '1' and ot.class = 'ot_total' order by o.orders_id DESC ";
		}
		elseif ($criteria == 3) {
			$orders_query_raw = "select distinct(o.orders_id), o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from orders_products op, orders o left join orders_total ot on (o.orders_id = ot.orders_id), orders_status s where (op.products_name like '%". $search_string ."%' or op.products_model like '%". $search_string ."%') and op.orders_id = o.orders_id and o.orders_status = s.orders_status_id and s.language_id = '1' and ot.class = 'ot_total' order by o.orders_id DESC ";
		}
		elseif ($criteria == 4) {
			$orders_query_raw = "select o.orders_id, o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from orders o left join orders_total ot on (o.orders_id = ot.orders_id), orders_status s where o.payment_method like '%". $search_string ."%' and o.orders_status = s.orders_status_id and s.language_id = '1' and ot.class = 'ot_total' order by o.orders_id DESC ";
		}
		elseif ($criteria == 5) {
			$orders_query_raw = "select distinct(o.orders_id), o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from orders o, orders_status_history osh left join orders_total ot on (o.orders_id = ot.orders_id), orders_status s where osh.comments like '%". $search_string ."%' and o.orders_id = osh.orders_id and o.orders_status = s.orders_status_id and s.language_id = '1' and ot.class = 'ot_total' order by o.orders_id DESC ";
		}
		elseif ($criteria == 6) {
			$orders_query_raw = "select o.orders_id, o.customers_name, o.payment_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, s.orders_status_name, ot.text as order_total from orders o left join orders_total ot on (o.orders_id = ot.orders_id), orders_status s where ot.title like '%". $search_string ."%' and o.orders_id = ot.orders_id and o.orders_status = s.orders_status_id and s.language_id = '1' and ot.class = 'ot_shipping' order by o.orders_id DESC ";
		}
	}
	//ORDER SEARCH STRING
