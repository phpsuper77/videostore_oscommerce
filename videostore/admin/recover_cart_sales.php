...
<!-- body_text //-->
	...
	<table width="100%">
		<tr><td bgcolor="#FF9F9F" style="border:1px black solid; width: 20px;"></td><td class="smalltext">Row highlight color for contacted customers.<br>An contacted customer is one that you <i>have</i> used this tool to send an email to before.</td></tr>
		<tr><td bgcolor="#0000FF" style="border:1px black solid; width: 20px;"></td><td class="smalltext">Color for the word/phrase used to notate a current customer<br>A current customer is someone who has purchased items from your store in the past.</td></tr>
		<tr><td bgcolor="#9FFFFF" style="border:1px black solid; width: 20px;"></td><td class="smalltext">Row highlight color for entrees that may have a matching order.<br>An entry will be marked with this color if an order contains one or more of an item in the abandoned cart <b>and</b> matches either the cart's customer email address or database ID.</td></tr>
		<tr><td bgcolor="#9FFF9F" style="border:1px #000000 solid; width: 20px;"></td><td class="smalltext">Row highlight color for uncontacted customers.<br>An uncontacted customer is one that you have <i>not</i> used this tool to send an email to before.</td></tr>
	</table>
      ...
      if ($curcus != "")
		{
			...
			if (mysql_num_rows($donequery) > 0) {
				...
				if( $ttl )
				{
					if( tep_not_null($ttl['datemodified']) )	// allow for older scarts that have no datemodified
