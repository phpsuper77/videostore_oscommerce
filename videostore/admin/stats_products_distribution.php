...
?>
		...
		<table border="0" width="1800" cellspacing="0" cellpadding="2" class="table scrollTable">
              <tr class="dataTableHeadingRow">		
                      <td width="70" align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=products_id&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Products Id</a></td>
                      <td width="70" align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=customerflix_id&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Customerflix Id</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=master&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>" alt="Master" title="Master">M</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=cover&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>" alt="Cover" title="Cover">C</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=label&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>" alt="Label" title="Label">L</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=web&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>" alt="Web" title="Web">Web</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=amazon&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>" alt="Amazon" title="Amazon">Am</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=mediazone&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>" alt="MediaZone" title="MediaZone">Media</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=google&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>" alt="Google" title="Google">G</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=akimbo&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>" alt="Akimbo" title="Akimbo">Ak</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=ded&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>" alt="Distribution End Date" title="Distribution End Date">DED</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=title&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Title</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=products_model&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Product Model</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=products_name&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Product Title</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=head_desc&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Head Description</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=producers_name&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Producer Name</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=products_vendors&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Vendors Name</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=run_time&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>&ctr=<?=$_GET['ctr']?>">Run Time</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=upc&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">UPC</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=asin&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">ASIN</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=clip_name&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Clip Name</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=products_clip&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Clip URL</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=keywords&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Keywords</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=products_quantity&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Quantity</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=price&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Price</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=set_type&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Set Type</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=video_format&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Video Format</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=code_name&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Region Code Name</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=code_descr&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Region Code Description</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=media_type&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Media Type</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=packaging_type&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Packaging Type</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=product_url&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Product URL</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=products_description&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Product Description</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=products_summary&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Product Summary</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=audio_language&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Audio Language</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=subtitle_language&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Subtitle Language</a></td>
                      <td align="center" class="dataTableHeadingContent r"><a href="stats_products_distribution.php?orderfield=product_release&ordersort=<?=$_SESSION['ordersort']?>&ctr=<?=$_GET['ctr']?>">Release Date</a></td>
              </tr>
<?php
 $whos_online_query_full1 = tep_db_query("SELECT sr.series_name as title, p.products_audio_languages, p.customerflix_id, p.products_subtitle_languages ,p.products_summary, p.products_quantity, p.products_id, p.products_model, p.products_run_time,p.products_upc, p.products_release_date, p.products_asin,p.products_price,  p.series_id, f.products_video_format_name,pd.products_name_prefix, pd.products_description, pd.products_name, pd.products_name_suffix, pd.products_clip_url, pd.products_head_desc_tag,pd.products_head_keywords_tag,pd.products_url,pd.products_clip_name,c.producers_name, pv.vendors_id, v.vendors_name,	pv.master, pv.cover, pv.label, pv.web, pv.amazon, pv.mediazone, pv.google, pv.akimbo, pv.distribution_end_date, r.products_region_code_name,r.products_region_code_desc,m.products_media_type_name, pk.products_packaging_type_name,st.products_set_type_name, IF(s.status, s.specials_new_products_price, NULL) as specials_new_products_price, IF(s.status, s.specials_new_products_price, p.products_price) as final_price FROM (((((((((products p, products_description pd, producers c) LEFT JOIN series sr on p.series_id = sr.series_id) LEFT JOIN products_to_vendors pv on p.products_id = pv.products_id) LEFT JOIN products_video_formats f on p.products_video_format_id = f.products_video_format_id) LEFT JOIN vendors v on pv.vendors_id=v.vendors_id) LEFT JOIN products_region_codes r on p.products_region_code_id=r.products_region_code_id) LEFT JOIN products_media_types m on p.products_media_type_id=m.products_media_type_id) LEFT JOIN products_packaging_types pk on p.products_packaging_type_id=pk.products_packaging_type_id) LEFT JOIN specials s on p.products_id = s.products_id) LEFT JOIN products_set_types st on p.products_set_type_id  = st.products_set_type_id WHERE p.producers_id = c.producers_id AND p.products_id = pd.products_id AND p.products_distribution=1 ".$order);
$s=20;
//$s=1000;
...
?>
              <tr class="dataTableRow" onMouseOver="rowOverEffect(this)" onMouseOut="rowOutEffect(this)" >
                <td width="70" height="55" align="center" class="dataTableContent t r"><?php echo $products['products_id']; ?></td>
...
<td class="dataTableContent t r" align="center"><?php echo $products['products_date_available']; ?></td>
              </tr>
<?php
  }
?>
...
?>
      ...
      <tr>
       ...
       <? 
			...
			$per = tep_db_num_rows($whos_online_query_full1)/$s;
			for ($k=1;$k<$per+1;$k++){
				$t=$k-1;
				if($_GET["orderfield"]!="" && $_GET["ordersort"]!="" ){
				     echo '<option value="stats_products_distribution.php?orderfield='.$_GET["orderfield"].'&ordersort='.$_GET["ordersort"].'&ctr='.$t.'">'.$k.'</option>'; 	
			    }else{
					echo '<option value="stats_products_distribution.php?ctr='.$t.'">'.$k.'</option>'; 	
				}
			}
	 ?>
