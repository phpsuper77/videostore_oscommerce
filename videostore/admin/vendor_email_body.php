...
if ($_GET[action]=='save'){
	...
	fclose($fp);			
	echo "<script>window.location.href='vendor_email_body.php';</script>";
}
...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading">AMAZON ORDER CONFIRMATION</td>
          </tr>
					<tr>
	...
	<form action="vendor_email_body.php?action=save" method="post">
