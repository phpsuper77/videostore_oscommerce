...
// needs to be included earlier to set the success message in the messageStack  
  ...
  if (isset($HTTP_POST_VARS['action'])) {
    ...
    if ($HTTP_POST_VARS['affiliate_order_notification']=='on')
    ...
    if (!$error) {
      $sql_data_array = array('affiliate_firstname' => $a_firstname,
			      ...
			      'affiliate_order_notification' => $affiliate_order_notification,  
			      'affiliate_notification_email' => $affiliate_notification_email);
...
?>
    <td width="100%" valign="top"><?php echo tep_draw_form('affiliate_details', tep_href_link(FILENAME_AFFILIATE_DETAILS, '', 'SSL'), 'post','enctype="multipart/form-data"', 'onSubmit="return check_form();"') . tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
