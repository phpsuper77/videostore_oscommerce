...
*/
  ...
  $affiliate_sales_raw = "
    select  a.*, o.orders_status as orders_status_id, os.orders_status_name as orders_status, a.affiliate_orders_id from " . TABLE_AFFILIATE_SALES . " a 
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="4">
          ...
          <tr>
            ...
            <td class="infoBoxHeading" align="center"><?php echo TABLE_HEADING_ORDER_NO; ?></td>
...
<?php
		if ($affiliate_sales['orders_status'] <> 'Cancelled')
			echo "<a href=affiliate_order_details.php?order_id=".$affiliate_sales['affiliate_orders_id'].">".$affiliate_sales['affiliate_orders_id']."</a></td>";
			else
				echo "-";
?>
