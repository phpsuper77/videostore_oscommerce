              ...
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="' . tep_href_link(FILENAME_AFFILIATE_BANNERS_BUILD_CAT, '', 'SSL'). '">' . TEXT_AFFILIATE_BANNERS_BUILD . '</a>';?></td>
                  </tr>
                  <tr>
                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="' . tep_href_link(FILENAME_AFFILIATE_BANNERS_BUILD, '', 'SSL'). '">' . TEXT_AFFILIATE_BANNERS_PRODUCT . '</a>';?></td>
