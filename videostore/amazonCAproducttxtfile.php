<?php
	...
	while($result_row = mysql_fetch_array($result))
	{
       //special price
		...
		{
multiplication: $sp_result_row['specials_new_products_price'] * 1.25 = $sp_result_row['specials_new_products_price']
			echo $sp_result_row['specials_new_products_price']."\t";
		}
		else
		{
multiplication: $sp_result_row['products_price'] * 1.25 = $sp_result_row['products_price']			
