...
MyLog("<hr/>-------------- start checkout_process-------------------<hr/>");
...
echo '<script type="text/javascript"> alert("first");</script>';
...
//var_dump($_SESSION, "<hr/>", $_SESSION['shipping_quotes']);
  ...
  //var_dump($_SESSION);exit;  
    ...
    if ($payment == 'paypal_express' || $payment == 'paypal_uk_express') {
      ...
      if ($payment == 'paypal_express') {
        ...
        //echo tep_href_link('express.php', '', 'SSL');
      } else {
