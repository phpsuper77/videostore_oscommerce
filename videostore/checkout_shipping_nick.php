...
if ((MODULE_SHIPPING_FREECOUNT_STATUS == 'True') && ($order->delivery['country_id'] == STORE_COUNTRY) ) $cheapship = 'freecount_freecount'; else $cheapship = $shipping_modules->cheapest();

  if ( !tep_session_is_registered('shipping') || ( tep_session_is_registered('shipping') && ($shipping == false) && (tep_count_shipping_modules() > 1) ) ) $shipping = $cheapship;

 //eof

  if ($cheapestOne) $shipping[id] = 'freecount_freecount';
