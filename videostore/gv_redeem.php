...
<!-- left_navigation_eof //-->
    ...
    <!-- body_text //-->
    <td background="/images/dotline_vertical.gif"><img height=1 alt="" src="/images/supplements.gif" width=1></td>
    <td ><img height=1 alt="" src="/images/supplements.gif" width=5></td>
