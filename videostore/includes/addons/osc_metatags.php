<?php
	...
	define('OSC_BASE_KEYWORDS','travel, dvd, video, documentary, film, geography, sightseeing, tour, tourist, holiday, souvenir');
	define('OSC_DEFAULT_DESC','Travel Videos including Sightseeing, Destination, Vacation, Cultural, Souvenir, Tourist, and Travelogue films on DVD');
 ...
 *													*/
	...
	*/
	...
	define('OSC_BASE_TITLE', "Travel DVD Video");
