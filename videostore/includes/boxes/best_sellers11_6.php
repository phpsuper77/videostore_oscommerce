...
if (tep_not_null($best_sellers['products_buy_download_link'])) 
	if ($best_sellers[adgregate] == 1) {
      $download_clip = '&nbsp;&nbsp;&nbsp;<a href="#" onclick="window.open(\'adgregate.php?id=' . ($best_sellers['products_id']) . '\',\'_blank\',\'width=320,height=320\');return false" target=_new><img src="images/download.gif" border="0" alt="Can\'t wait for the DVD, click here to purchase the download" title="Can\'t wait for the DVD, click here to purchase the download"></a>';
	}
	else{
      $download_clip = '&nbsp;&nbsp;&nbsp;<a href="video.php?products_id='.$best_sellers['products_id'].'" target=_new><img src="images/download.gif" border="0" alt="Can\'t wait for the DVD, click here to purchase the download" title="Can\'t wait for the DVD, click here to purchase the download"></a>';
	}

if ($best_sellers[adgregate] == 1) {
      $bestsellers_list .= '<tr><td class="infoBoxContents" valign="top">' . tep_row_number_format($rows) . '.</td><td class="infoBoxContents">' . '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '">' . '<b>' . $best_sellers['series_name'] . '&nbsp;</b>&nbsp;' . $best_sellers['products_name_prefix'] . ' <b>' . $best_sellers['products_name'] . '</b> ' . $best_sellers['products_name_suffix'] . '</a>-' . $best_sellers['products_media_type_name']';
 $download_clip = '&nbsp;&nbsp;&nbsp;<a href="#" onclick="window.open(\'adgregate.php?id=' . ($best_sellers['products_id']) . '\',\'_blank\',\'width=320,height=320\');return false" target=_new><img src="images/video_clip.gif" border="0" alt="View Free Video Clip" title="View Free Video Clip"></a></td></tr>';


  
} else {
    $bestsellers_list .= '<tr><td class="infoBoxContents" valign="top">' . tep_row_number_format($rows) . '.</td><td class="infoBoxContents">' . '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '">' . '<b>' . $best_sellers['series_name'] . '&nbsp;</b>&nbsp;' . $best_sellers['products_name_prefix'] . ' <b>' . $best_sellers['products_name'] . '</b> ' . $best_sellers['products_name_suffix'] . '</a>-' . $best_sellers['products_media_type_name'] . '<br><a href="#" onClick="window.open(\'' . ($best_sellers['products_clip_url']) . '\',\'_blank\',\'width=660,height=390\');return false"><img src="images/video_clip.gif" border="0" alt="View Free Video Clip"></a>'.$download_clip.'</td></tr>'; }
...
if ($best_sellers[adgregate] == 1)  {
 $download_clip = '&nbsp;&nbsp;&nbsp;<a href="#" onclick="window.open(\'adgregate.php?id=' . ($best_sellers['products_id']) . '\',\'_blank\',\'width=320,height=320\');return false" target=_new><img src="images/download.gif" border="0" alt="Can\'t wait for the DVD, click here to purchase the download" title="Can\'t wait for the DVD, click here to purchase the download"></a>';
$bestsellers_list .= '<tr><td class="infoBoxContents" valign="top">' . tep_row_number_format($rows) . '.</td><td class="infoBoxContents">' . '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '">' . '<b>' . $best_sellers['series_name'] . '&nbsp;</b>&nbsp;' . $best_sellers['products_name_prefix'] . ' <b>' . $best_sellers['products_name'] . '</b> ' . $best_sellers['products_name_suffix'] . '</a>-' . $best_sellers['products_media_type_name']';
 $download_clip = '&nbsp;&nbsp;&nbsp;<a href="#" onclick="window.open(\'adgregate.php?id=' . ($best_sellers['products_id']) . '\',\'_blank\',\'width=320,height=320\');return false" target=_new><img src="images/video_clip.gif" border="0" alt="View Free Video Clip" title="View Free Video Clip"></a></td></tr>'; } else {
