...
$info_box_contents[] = array('text' =>
                                ...
                                '<a href="' . tep_href_link(FILENAME_FAQ) . '">' . BOX_INFORMATION_FAQ . '</a><br>' . 	//FAQ SYSTEM 2.1
										'<a href="' . tep_href_link(FILENAME_SHIPPING) . '">' . BOX_INFORMATION_SHIPPING . '</a><br>' .
            ...
            /*CHANGES MADE HERE*/	   	'<a href="' . tep_href_link($Links) . '">' . $link_name .' ' .BOX_INFORMATION_LINKS . '</a><br>');
