...
$info_box_contents[] = array('text' =>
										...
										'<a href="' . tep_href_link(FILENAME_PURCHASE_ORDERS) . '">' . 'Purchase Orders' . '</a><br>' .
										'<a href="' . tep_href_link(FILENAME_SHIPPING) . '">' . BOX_INFORMATION_SHIPPING . '</a><br>' .
'<a href="http://www.travelvideostore.com/returns.php">Guarantee - Returns</a><br>' .
                                       	'<a href="' . tep_href_link(FILENAME_PRIVACY) . '">' . BOX_INFORMATION_PRIVACY . '</a><br>' .
                                       	'<a href="' . tep_href_link(FILENAME_CONDITIONS) . '">' . BOX_INFORMATION_CONDITIONS . '</a><br>' .
            /*CHAGES MADE HERE*/	   	'<a href="' . tep_href_link($Links) . '">' . $link_name .' ' .BOX_INFORMATION_LINKS . '</a><br>' . // VJ Links Manager v1.00 added
                                                '<a href="' . tep_href_link(FILENAME_SITEMAP) . '">' . 'Sitemap' . '</a><br>' .
