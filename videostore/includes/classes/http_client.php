...
// connect if necessary
      if ( ($this->socket == false) || (feof($this->socket)) ) {
	    ...
	    mail('creditcardreceipt@travelvideostore.com','Connection Error: '.$this->replyString, "Error number: ".$this->reply."<br>Error String: ".$this->replyString."<br>Host: ".$host."<br>Port: ".$port, $headers);
