...
#
#	CLASS: page_cache.php, v1.0 2004/10/27
#	AUTHOR: Chemo (chemo@bdcconcepts.com)
#  	PURPOSE: Decrease server load, increase page load performance
#  
#  	If you would like to send a donation please PayPal: paypal@bdcconcepts.com
################################################################################
\*-----------------------------------------------------------------------------*/
