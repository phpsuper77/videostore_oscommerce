...
*/
  ...
  function tep_db_query($query, $link = 'db_link') {
	...
	$_db_queries_list .= "<br/><br/><b>".$db_queries_count."</b> - ".$query."";

	$qlocation = $_SERVER["SCRIPT_FILENAME"];
	if ($parsetime > 0.5) { // change the 0.5 to a value that you think is acceptable for queries

		//$query2 = "INSERT INTO qlog VALUES ('', '" . tep_db_input($query) . "', '".$qlocation."', '" . $parsetime . "', now())";
