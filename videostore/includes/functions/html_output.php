...
// The HTML href link wrapper function
  function tep_href_link($page = '', $parameters = '', $connection = 'NONSSL', $add_session_id = true, $search_engine_safe = true) {
	...
	return href_link($page, $parameters, $connection, $add_session_id, $search_engine_safe);
...
//////////// NEW
  function tep_draw_pull_down_menu_new($name, $values, $def, $parameters = '', $required = false) {
    $field = '<select name="' . tep_output_string($name) . '"';
...
// The HTML form submit button wrapper function
// Outputs a button in the selected language
  function tep_image_submit_vendors($image, $alt = '', $parameters = '') {
    global $language;

    $image_submit = '<input type="image" src="' . $image . '" border="0" alt="' . tep_output_string($alt) . '"';
...
////
	...
	require_once(OSC_FUNCTION_FOLDER.'seo_urls/seo_urls_html_output_0.php');
?>
