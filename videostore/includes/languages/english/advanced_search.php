...
define('TABLE_HEADING_MEDIA', 'VHS DVD<BR>');
define('TABLE_HEADING_PRODUCTS', 'Product Name (Brief Description)<BR>');
define('TABLE_HEADING_MANUFACTURER', 'Manufacturer');
define('TABLE_HEADING_QUANTITY', 'Quantity<BR>');
define('TABLE_HEADING_PRICE', 'Price<BR>');
define('TABLE_HEADING_WEIGHT', 'Weight');
define('TABLE_HEADING_BUY_NOW', 'Add to Cart<br>');

define('TEXT_NO_PRODUCTS', '<br><span style="font-size:11px;">Your search - <b>' . stripslashes($_GET['keywords']) . '</b> - did not match any products.</span><br><br>Some Suggestions:<ol><li>Check that your spelling was accurate.</li><li>Try using different keywords</li><li>Try using fewer keywords</li><li>Try using more general keywords</li></ol>');
