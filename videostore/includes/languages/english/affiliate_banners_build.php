...
define('HEADING_TITLE', 'Affiliate Program - Build a Product Link');
...
define('TEXT_AFFILIATE_INDIVIDUAL_BANNER_INFO','<b>Enter the PRODUCT number you wish to link to and press the Build Link Button.</b><br><br>You may also go to the individual product detail pages and click the BUILD LINK button under the product image on the product detail pages to create individual product links when you are logged in to the affiliate system.<br><br>');
