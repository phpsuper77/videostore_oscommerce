...
define('EMAIL_PASSWORD_REMINDER_BODY', 'A new affiliate password was requested from ' . $REMOTE_ADDR . '.' . "\n" . 'Your new affiliate password to \'' . STORE_NAME . '\' is:' . "\n" . '   %s' . "\n" . 'To login to your affiliate account please go to https://secure.travelvideostore.com/affiliate_affiliate.php you may change your password once you have logged in by selecting the menu option under the left column Affiliate box.');
