...
define('TEXT_AFFILIATE_BANNERS_BANNERS', 'Select a Banner Links');
define('TEXT_AFFILIATE_BANNERS_BUILD', 'Build a Category Link');
define('TEXT_AFFILIATE_BANNERS_PRODUCT', 'Build a Product Link');
define('TEXT_AFFILIATE_BANNERS_TEXT', 'Select a Text Links');
