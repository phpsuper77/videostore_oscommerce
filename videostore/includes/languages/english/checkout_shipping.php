...
define('TABLE_HEADING_COMMENTS', 'Special Instructions - This does not appear on your invoice or your Packing Slip');
...
define('TABLE_HEADING_GIFTWRAP_METHOD', 'GiftWrap');//ADDED FOR GIFT WRAP
define('TEXT_CHOOSE_GIFTWRAP_METHOD', 'Would you like to GiftWrap this order?');//ADDED FOR GIFT WRAP
