...
define('EMAIL_CONTACT', 'For help with any of our online services, please email Customer Service: ' . STORE_OWNER_EMAIL_ADDRESS . '.' . "\n\n");
define('EMAIL_WARNING', '<b>Note:</b> This email address was given to us by one of our customers. There is no charge for an account nor are you added to our mailing list unless you have selected to receive our monthly newsletter.  If you did not signup to setup an account, please send an email to ' . STORE_OWNER_EMAIL_ADDRESS . '.' . "\n");
