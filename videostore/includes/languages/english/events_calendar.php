...
*/
  ...
  define('TEXT_EVENT_END_DATE', 'To :');
  define('TEXT_EVENT_LINK', 'Link :');
  define('TEXT_EVENT_OSC_LINK', 'OSC link :');
  define('TEXT_EVENT_TITLE', '');
  define('TEXT_EVENT_DESCRIPTION', '');
  define('TEXT_EVENT_MORE', '... Click for More Info >>');
  ...
  define('MAX_DISPLAY_NUMBER_EVENTS', 15);
