...
if ( ($category_depth == 'products') || (isset($HTTP_GET_VARS['distributors_id'])) || (isset($HTTP_GET_VARS['producers_id'])) || (isset($HTTP_GET_VARS['series_id'])) ) {
  define('HEADING_TITLE', '');
  define('TABLE_HEADING_IMAGE', '');
  define('TABLE_HEADING_MODEL', 'Model');
  define('TABLE_HEADING_PRODUCTS', 'Video Title');
  define('TABLE_HEADING_MEDIA', 'VHS or DVD');
  define('TABLE_HEADING_MANUFACTURER', 'Producers');
  define('TABLE_HEADING_QUANTITY', 'Quantity');
  define('TABLE_HEADING_PRICE', 'Price');
  define('TABLE_HEADING_WEIGHT', 'Weight');
  define('TABLE_HEADING_BUY_NOW', '');
  define('TEXT_NO_PRODUCTS', 'There are no products to list .');
  define('TEXT_NO_PRODUCTS2', 'There is no product available from this producer.');
  define('TEXT_NUMBER_OF_PRODUCTS', 'Number of Products: ');
  define('TEXT_SHOW', '<b>Show:</b>');
  define('TEXT_BUY', 'Buy 1 \'');
  define('TEXT_NOW', '\' now');
  define('TEXT_ALL_CATEGORIES', 'All Categories');
  define('TEXT_ALL_MANUFACTURERS', 'All Producers');
