...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_EXPRESS_TEXT_PUBLIC_TITLE', '<img src="https://www.paypal.com/en_US/i/logo/PayPal_mark_37x23.gif" align="" style="margin-right:7px;"><span style="font-size:11px; font-family: Arial, Verdana;">The safer, easier way to pay.</span>');
