...
define('TEXT_MAIN', 'If you\'ve forgotten your password, enter your e-mail address below and we\'ll send you an e-mail message containing your new password, you may change it to whatever you like after you\'ve successfully logged in.');
...
define('EMAIL_REMINDER_BODY', 'A new email was requested from ' . $REMOTE_ADDR . '.' . "\n\n" . 'Your new email to \'' . STORE_NAME . '\' is:' . "\n\n" . '   %s' . "\n\n");
?>
