...
define('HEADING_COUPON_HELP', 'Discount Coupon Details');
...
define('TEXT_COUPON_HELP_FIXED', '<br><br>The coupon is worth %s discount against your order and will be calculated during checkout on your order confirmation page');
