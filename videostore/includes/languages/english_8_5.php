...
define('TEXT_FREE_SHIPPING_LIMIT', 'All <u>US Delivered</u> orders having over %s items receive FREE shipping!');
define('TEXT_FREE_SHIPPING_LIMIT_INTERNATIONAL', 'All orders having over %s items receive FREE shipping outside of %s.');
define('TEXT_FREE_SHIPPING_LIMIT_NATIONAL', '<b>All <u>US Delivered orders</u> having over %s items receive FREE shipping within %s.<b>');
