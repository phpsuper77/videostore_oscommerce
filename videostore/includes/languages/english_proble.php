...
define('BOX_INFORMATION_ALLCATEGORIES', 'View All CATEGORIES');
...
// Who's online
define('BOX_HEADING_WHOS_ONLINE', 'Who is online?');
...
define('TEXT_ADD_TO_GET_FREE_SHIPPING', '[<b>add %s more item(s) for free shipping</b>]');
define('TEXT_FREE_SHIPPING_RECEIVED', '<b>You have qualified for free shipping.</b>');
define('TEXT_FREE_SHIPPING_LIMIT', 'All orders having over %s items receive FREE shipping!');
define('TEXT_FREE_SHIPPING_LIMIT_INTERNATIONAL', 'All orders having over %s items receive FREE shipping outside of %s.');
define('TEXT_FREE_SHIPPING_LIMIT_NATIONAL', '<b>All orders having over %s items receive FREE shipping within %s.<b>');
define('TEXT_FREE_SHIPPING_RECEIVED_INTERNATIONAL', '<b>You have qualified for free shipping outside of %s.<b>');
define('TEXT_FREE_SHIPPING_RECEIVED_NATIONAL', '<b>You have qualified for free shipping within %s.<b>');
...
define('TEXT_GREETING_GUEST', 'Welcome <span class="greetUser">Guest!</span> <a href="%s"><u>Login</u></a>? Or <a href="%s"><u>Setup an account</u></a>?');
...
*/
define('FOOTER_TEXT_BODY', 'Copyright &copy; 2004 TravelVideoStore.com<BR>5420 Boran Dr<BR>Tampa FL 33610<BR>Worldwide Tollfree (800) 288-5123<BR>Direct USA 813-630-9778<BR>FAX 813-627-0334');
?>