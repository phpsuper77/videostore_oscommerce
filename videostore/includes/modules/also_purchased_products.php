...
if($oplist[$orders['products_id']]){
 $ap='<br>' . ALREADY_PURCHASED . '';
}else{
$ap='';
}
        ...
        $info_box_contents[$row][$col] = array('align' => 'center',
                                               ...
                                               'text' => '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $orders['products_id']) . '">' . tep_image(DIR_WS_IMAGES . $orders['products_image'], $orders['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a><br>
<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $orders['products_id']) . '">' . $orders['products_name'] . '</a>' . $ap);
