...
//echo "*******".$order->info['total']." - ".$od_amount."*****";

//echo round($order->info[total],2)."-".round($od_amount,2);
        $order->info[total] = round($order->info[total],2)-round($od_amount,2);
//echo "*******".$order->info['total']."*******";
//$final_end = $order->info['total']-$od_amount;
//$order->info[total] = $final_end;
//echo "*******".$order->info['total']." - ".$od_amount."*****".$order->info[total]."------";

			///////////////////Newly added
				//	tep_session_register('od_amount');
