...
*/
  ...
  class freecount {
    var $code, $title, $description, $icon, $enabled,$ab;
		...
		foreach($order as $key=>$value)
		 {
			...
			//$_SESSION['nfree'] = $no_free;
			
			//$ab[]=$no_free;
			$this->ab=$no_free;
			//array_push($this->ab,$no_free);
...
// class constructor
 ...
 ///////////////////// coded by Anil///////////////////////
	...
	elseif (($_SESSION[whole][iswholesale] == 1) && ($_SESSION[whole][shipping1] == 1) && ($_SESSION['nondist_weight'] == 0)) {
       }
	elseif (($_SESSION[whole][iswholesale] == 1) && ($_SESSION[whole][shipping1] == 1) && ($_SESSION['nondist_weight'] != 0)) {
         $_SESSION['weight'] = $_SESSION['nondist_weight'];
         $this->enabled = false;
       }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	  
     ...
     elseif ( ($this->enabled == true) && ((int)MODULE_SHIPPING_FREECOUNT_NUMBER <= $total_count)&& ($_SESSION[whole][iswholesale] != 1)) {
    ...
    function quote($method = '') {
      ...
      $this->quotes = array('id' => $this->code,
                            ...
                            'methods' => array(array('id' => $this->code,
                                                     ...
                                                     'cost' => (0.00) + MODULE_SHIPPING_FREECOUNT_HANDLING)));

      if (($this->tax_class > 0)&& ($_SESSION[whole][iswholesale] != 1))  {
