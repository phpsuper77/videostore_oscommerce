...
//var_dump($order);exit;
    ...
    if ($order->delivery['country']['id'] == SHIPPING_ORIGIN_COUNTRY)
        ...
        // DEBUG RATE QUOTE // $emailRequest = $request;
        ...
        /////////////////////////////////////////
//echo("<textarea>" . $request . "</textarea>"); exit;        
        ...
        // DEBUG RATE QUOTE // try {
             // DEBUG RATE QUOTE // $requestDoc = new SimpleXmlElement(http_chunked_decode($emailRequest));
             // DEBUG RATE QUOTE // $responseDoc = new SimpleXmlElement(http_chunked_decode($body));

            // DEBUG RATE QUOTE // $dom = dom_import_simplexml($requestDoc)->ownerDocument;
            // DEBUG RATE QUOTE // $dom->formatOutput = true;
            // DEBUG RATE QUOTE // $requestOut = $dom->saveXML();

            // DEBUG RATE QUOTE // $dom = dom_import_simplexml($responseDoc)->ownerDocument;
            // DEBUG RATE QUOTE // $dom->formatOutput = true;
            // DEBUG RATE QUOTE // $responseOut = $dom->saveXML();

             // DEBUG RATE QUOTE // mail('securityadmin@commonsenserc.com','USPS Rate Quote'
                    // DEBUG RATE QUOTE // ,$requestOut . "\n\n" . $responseOut . "\n\n"
                    // DEBUG RATE QUOTE // ,'From: <securityadmin@commonsenserc.com>'
             // DEBUG RATE QUOTE // );  
        // DEBUG RATE QUOTE // } catch(Exception $e) {
             // DEBUG RATE QUOTE // mail('securityadmin@commonsenserc.com'
                            // DEBUG RATE QUOTE // ,'USPS Rate Quote response ERROR',$e->getMessage() . "\n\n" . $body,'From: <securityadmin@commonsenserc.com>');  
        // DEBUG RATE QUOTE // }
        ...
        // use SimpleXml for parsing international quotes
        // if ($order->delivery['country']['id'] != SHIPPING_ORIGIN_COUNTRY) {
            // $bodyDoc = new SimpleXmlElement(http_chunked_decode($body));
        // }
        ...
        $body = preg_replace('/Priority Mail\ [0-9]+[\ -][dD]ay[^<]*/', 'Priority Mail tradmrk', $body);

//echo("<textarea>" . $body . "</textarea>"); exit;
        /////////////////////////////////////////
