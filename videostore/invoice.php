...
<body marginwidth="0" marginheight="0" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" bgcolor="#FFFFFF" onload="self.print()">
...
if ($order->products[$i]['has_rights']=='1') echo '<br/>&nbsp;<a style="color:red;" href="#" onclick="getRights(); return false;">Includes Limited Public Performance Rights</a>';
//var_dump($order);
      echo '	    </td>' . "\n" .
