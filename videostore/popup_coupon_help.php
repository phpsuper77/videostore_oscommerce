...
<?php
  ...
  $new_coupon_amount = '"A free product"' ;
  } else {
	$new_coupon_amount =   $currencies->format($coupon['coupon_amount']);
  }
  switch ($coupon['coupon_type']) {
    case 'F':
    $text_coupon_help .= sprintf(TEXT_COUPON_HELP_FIXED, $new_coupon_amount);
    break;
    case 'P':
