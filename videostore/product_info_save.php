...
?>
      <tr>
        <td><table border="1" width="100%" cellspacing="0" cellpadding="0">
          <tr>
		    <td align="center" valign="middle"><?php  echo '<img src=../images/media_type/' . $product_info['products_media_type_id'] . '.gif border=0></img><BR><span class="smallText">' . $product_info['products_set_type_name'] . '</span>' ?></td>
...
<!-- // BOF MaxiDVD: Modified For Ultimate Images Pack! //-->
<?php
	echo  $product_info['products_run_time'] . '<BR>';
...
?>
			...
			<p><?php echo $product_info['products_byline']?></p>
	  ...
	  <tr>
	   ...
	   <table class="smallText" border="1">
	   	<tr>
	     <td class="smallText" colspan="2" bgcolor="#CCCCCC" align="center">Product Details</td>
	    </tr>
	    <tr>
	     <td class="smallText">Distributor -</td><td class="smallText"><?php echo $product_info['distributors_name']?></td>
	    </tr>
	    <tr>
	     <td class="smallText">Producer -</td><td class="smallText"><?php echo $product_info['producers_name']?></td>
	    </tr>
	    <tr>
	     <td class="smallText">Series -</td><td class="smallText"><?php echo $product_info['series_name']?></td>
	    </tr>
		<tr>
	     <td class="smallText">Video Format -</td><td class="smallText"><?php echo $product_info['products_video_format_name']?></td>
	    </tr>
		<tr>
	     <td class="smallText">Audio Type -</td><td class="smallText"><?php echo $product_info['products_audio_name']?></td>
	    </tr>
		<tr>
	     <td class="smallText">Aspect Ratio -</td><td class="smallText"><?php echo $product_info['products_aspect_ratio_name']?></td>
	    </tr>
		<tr>
	     <td class="smallText">Closed Captioned -</td><td class="smallText"><?php echo $product_info['products_closed_captioned']?></td>
	    </tr>
		<tr>
	     <td class="smallText">PC Bonus Interactive -</td><td class="smallText"><?php echo $product_info['products_pc_bonus']?></td>
	    </tr>
		<tr>
		...
		<tr>
	     <td class="smallText">Byline -</td><td class="smallText"><?php echo $product_info['products_byline']?></td>
	    </tr>
		<tr>
	     <td class="smallText">Run Time -</td><td class="smallText"><?php echo $product_info['products_run_time']?></td>
	    </tr>
		<tr>
