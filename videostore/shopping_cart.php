...
if ($products[$i][products_always_on_hand]!=1){
      ...
      $info_box_contents[$cur_row][] = array('align' => 'right',
                                             'params' => 'class="productListing-data" valign="top"',
                                             'text' => '<b>' . $currencies->display_price($products[$i]['price'], tep_get_tax_rate($products[$i]['tax_class_id']), "1") . '</b>	');						 
      ...
      $info_box_contents[$cur_row][] = array('align' => 'right',
                                             'params' => 'class="productListing-data" valign="top"',
                                             'text' => '<b>' . $currencies->display_price($products[$i]['final_price'], tep_get_tax_rate($products[$i]['tax_class_id']), $products[$i]['quantity']) . '</b><div style="padding-right:3px;padding-top:3px;"><input onclick="document.getElementById(\'wish_product_id\').value='.$products[$i][id].'" type="image" src="images/copytowishlist.gif" border="0" alt="Add to Wishlist" title=" Add to Wishlist " name="wishlist" value="wishlist" border="0"></div>');
    }
