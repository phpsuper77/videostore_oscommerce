...
/*
  ...
  ---------------------------------------------
  Based on all_series.php,v 3.0 2004/02/21 by Ingo (info@gamephisto.de)
  ---------------------------------------------
...
<?php
   ...
   while($series = tep_db_fetch_array($series_query)) {
      $series_links = $series_links . '<a href="index.php/series_id/' . $series['series_id'] . '.html#' . $series['series_name'] . ' DVD VHS' . '">'  . $series['series_name'] . ' Travel Video Store DVD VHS' . '</a><br />';
   }
