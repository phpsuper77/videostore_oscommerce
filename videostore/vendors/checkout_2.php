<?php
error_reporting(E_ERROR | E_WARNING | E_PARSE); //Report all errors
...
if (intval($_SESSION["vendors_id"])==0)
  {
	tep_redirect("https://secure.travelvideostore.com/vendors/vendor_account.php");
	exit;
  }
...
// avoid hack attempts during the checkout procedure by checking the internal cartID
  if (isset($cart->cartID) && tep_session_is_registered('cartID')) {
    ...
    header('Location: https://secure.travelvideostore.com/vendors/checkout_1.php');
    exit;
    }
  }
...
//  if (isset($HTTP_POST_VARS['payment'])) $payment = $HTTP_POST_VARS['payment'];
  ...
  //$payment = 'paypal_direct';

// load the selected payment module

  DEFINE('MODULE_PAYMENT_INSTALLED','linkpointms1.php') ;
  //DEFINE('MODULE_PAYMENT_INSTALLED','paypal_direct.php') ;
...
//ICW ADDED FOR CREDIT CLASS SYSTEM
  require(DIR_WS_CLASSES . 'order_total.php');
      ...
      if (preg_match('/^4[0-9]{12}([0-9]{3})?$/', $_SESSION['vendor']['cc_number'])) {
        $cc_type_name = 'Visa';
      } elseif (preg_match('/^5[1-5][0-9]{14}$/', $_SESSION['vendor']['cc_number'])) {
        $cc_type_name = 'Master Card';
      } elseif (preg_match('/^3[47][0-9]{13}$/', $_SESSION['vendor']['cc_number'])) {
        $cc_type_name = 'American Express';
      } elseif (preg_match('/^3(0[0-5]|[68][0-9])[0-9]{11}$/', $_SESSION['vendor']['cc_number'])) {
        $cc_type_name = 'Diners Club';
      } elseif (preg_match('/^6011[0-9]{12}$/', $_SESSION['vendor']['cc_number'])) {
        $cc_type_name = 'Discover';
      } elseif (preg_match('/^(3[0-9]{4}|2131|1800)[0-9]{11}$/', $_SESSION['vendor']['cc_number'])) {
        $cc_type_name = 'JCB';
      } elseif (preg_match('/^5610[0-9]{12}$/', $_SESSION['vendor']['cc_number'])) { 
...
?>
            <td width="30%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main"><?php echo '<b>' . HEADING_DELIVERY_ADDRESS . '</b> <a href="https://secure.travelvideostore.com/vendors/distribution.php"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
              </tr>
              <tr>
...
?>
              <tr>
                <td class="main"><?php echo '<b>' . HEADING_SHIPPING_METHOD . '</b> <a href="https://secure.travelvideostore.com/vendors/checkout_1.php"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
              </tr>
              <tr>
...
?>
                  <tr>
                    <td class="main" colspan="2"><?php echo '<b>' . HEADING_PRODUCTS . '</b> <a href="https://secure.travelvideostore.com/vendors/distribution.php"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
...
?>
                  <tr>
                    <td class="main" colspan="3"><?php echo '<b>' . HEADING_PRODUCTS . '</b> <a href="https://secure.travelvideostore.com/vendors/distribution.php"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
                  </tr>
<?php
}
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td width="30%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main"><?php echo '<b>' . HEADING_BILLING_ADDRESS . '</b> <a href="https://secure.travelvideostore.com/vendors/distribution.php"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo tep_address_format($order->billing['format_id'], $order->billing, 1, ' ', '<br>'); ?></td>
              </tr>
              <tr>
                <td class="main"><?php echo '<b>' . HEADING_PAYMENT_METHOD . '</b> <a href="https://secure.travelvideostore.com/vendors/distribution.php"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
              </tr>
              <tr>
...
?>
      <tr>
        <td class="main"><?php echo '<b>' . HEADING_ORDER_COMMENTS . '</b> <a href="https://secure.travelvideostore.com/vendors/checkout_1.php"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
...
<?php
  if (isset($$payment->form_action_url)) {
    ...
    $form_action_url = 'https://secure.travelvideostore.com/vendors/checkout_complete.php';
  }
