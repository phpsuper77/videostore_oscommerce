...
if(isset($_GET['payment_error'])){
	...
	echo '<div style="background-color:#CF9; font-weight:bold; color:#F00;">'.$_GET['error'].'</div>';
...
?>
			...
			<tr><td colspan="6" align="center" style="color:red;"><b>
            
            <? if(isset($_GET['amp;error'])){ ?>
			<div style="background-color:#CF9; font-weight:bold; color:#F00;">Credit Card Information is not correct!!! Please try again</div><? } ?>
			
			<? if (!empty($error)) echo $error?></b></td></tr>
	        <tr>
		...
		<td width="50%">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <?
					...
					//echo "select * from ". TABLE_COUNTRIES ." where countries_id = ". intval($vendor['bill_country']);
		...
		<td width="50%">
			<table width="100%" cellspacing="0" cellpadding="0">
			  ...
			  <?
					...
					//echo "select * from ". TABLE_COUNTRIES ." where countries_id = ". intval($vendor['ship_country']);
