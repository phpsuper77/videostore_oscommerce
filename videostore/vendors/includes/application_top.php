...
// include the list of project filenames
	$DIR_WS_INCLUDES = bugFixRequirePath("../".DIR_WS_INCLUDES);
  require($DIR_WS_INCLUDES . 'filenames.php');
	require('includes/vendormissingfunctions.php');
...
// include the database functions
  $DIR_WS_FUNCTIONS = bugFixRequirePath("../".DIR_WS_FUNCTIONS);
...
// define general functions used application-wide
  ...
  // echo $DIR_WS_FUNCTIONS . 'html_output.php';exit;
...
// check if sessions are supported, otherwise use the php3 compatible session class
  ...
  $DIR_WS_CLASSES = bugFixRequirePath("../".DIR_WS_CLASSES);
...
// set the language
  if (!tep_session_is_registered('language') || isset($HTTP_GET_VARS['language'])) {
	...
	$DIR_WS_LANGUAGES = bugFixRequirePath("../".DIR_WS_LANGUAGES);
