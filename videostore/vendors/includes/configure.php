...
// * DIR_WS_* = Webserver directories (virtual/URL)
  ...
  define('HTTPS_SERVER', 'https://secure.travelvideostore.com'); // eg, https://localhost - should not be empty for productive servers
  define('ENABLE_SSL', 'true'); // secure webserver for checkout procedure?
  define('HTTP_COOKIE_DOMAIN', 'www.travelvideostore.com');
  define('HTTPS_COOKIE_DOMAIN', 'secure.travelvideostore.com');
  ...
  define('DIR_FS_CATALOG', '/home/terrae2/public_html/');
...
// define our database connection
  ...
  define('STORE_SESSIONS', 'mysql'); // leave empty '' for default handler or set to 'mysql'
	...
	define('OSC_CONFIG_FOLDER',bugFixRequirePath('../../includes/addons/configs/'));
	define('OSC_FUNCTION_FOLDER',bugFixRequirePath('../../includes/addons/'));
