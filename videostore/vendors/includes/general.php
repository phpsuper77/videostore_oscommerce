...
// Add tax to a products price
  function tep_add_tax($price, $tax) {
    ...
    if (DISPLAY_PRICE_WITH_TAX == 'true') {
      return "1---".tep_round($price, $currencies->currencies[DEFAULT_CURRENCY]['decimal_places']) + tep_calculate_tax($price, $tax);
    } else {
      return "2---".tep_round($price, $currencies->currencies[DEFAULT_CURRENCY]['decimal_places']);
    }
  }
