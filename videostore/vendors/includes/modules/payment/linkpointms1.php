...
$expires_month[] = array('id' => sprintf('%02d', $i), 'text' => $numeric . ' ' . strftime('%B',mktime(0,0,0,$i,1,2000)));
      ...
      $_SESSION[cc_number] = $_SESSION['real_cc_number'];
    ...
    function pre_confirmation_check() {
      ...
      $result = $cc_validation->validate($_SESSION['vendor']['cc_number'], $_SESSION['vendor']['cc_expires_month'], $_SESSION['vendor']['cc_expires_year']);
      ...
      if ( ($result == false) || ($result < 1) ) {
	    ...
	    //mail('x0661t@d-net.kiev.ua','Transaction Error', $body, $headers);
	    mail('creditcardreceipt@travelvideostore.com','Transaction Error: '.$myresult[statusMessage], $body, $headers);


        //tep_redirect(tep_href_link(FILENAME_CHECKOUT_PAYMENT, $payment_error_return, 'SSL', true, false));
	tep_redirect(tep_href_link('vendors/distribution.php', $payment_error_return, 'SSL', true, false));
	//header('Location: https://www.travelvideostore.com/vendors/distribution.php?'.$payment_error_return);
	exit;
      }
    ...
    function confirmation() {
      ...
      $confirmation = array('title' => $this->title . ': ' . $this->cc_card_type,
                            'fields' => array(array('title' => MODULE_PAYMENT_LINKPOINTMS1_TEXT_CREDIT_CARD_OWNER,
                                                    'field' => $_SESSION['vendor']['cc_owner']),
                                              array('title' => MODULE_PAYMENT_LINKPOINTMS1_TEXT_CREDIT_CARD_NUMBER,
                                                    'field' => substr($this->cc_card_number, 0, 4) . str_repeat('X', (strlen($this->cc_card_number) - 8)) . substr($this->cc_card_number, -4)),
                                              array('title' => MODULE_PAYMENT_LINKPOINTMS1_TEXT_CREDIT_CARD_EXPIRES,
                                                    'field' => strftime('%B, %Y', mktime(0,0,0,$_SESSION['vendor']['cc_expires_month'], 1, '20' . $_SESSION['vendor']['cc_expires_year'])))));
    ...
    function process_button() {
      ...
      $process_button_string = tep_draw_hidden_field('x_Cust_ID', $_SESSION['vendors_id']) .
                               tep_draw_hidden_field('x_Login', MODULE_PAYMENT_LINKPOINTMS1_LOGIN) .
                               tep_draw_hidden_field('x_CC_expdate_month', $_SESSION[vendor]['cc_expires_month']) .
                               tep_draw_hidden_field('x_CC_expdate_year', $_SESSION[vendor]['cc_expires_year']) .
                               tep_draw_hidden_field('cc_number', $_SESSION[vendor]['cc_number']) .
                               tep_draw_hidden_field('x_CC_cvmvalue', $_SESSION[vendor]['cc_checkcode']) .
                               tep_draw_hidden_field('cc_owner', $this->cutSymbols($_SESSION[vendor]['cc_owner'])) .
                               tep_draw_hidden_field('cc_type', $this->cc_card_type) .
                               tep_draw_hidden_field('cc_expires', $_SESSION[vendor]['cc_expires_month'] . $_SESSION[vendor]['cc_expires_year']) .
                               ...
                               tep_draw_hidden_field('x_Comments', $this->cutSymbols($order->info['comments'])) .
...
#	I STILL NEED TO SAVE THESE VALUES INTO THE DATABASE
	...
	header('Location: https://www.travelvideostore.com/vendors/checkout_2.php?error_message='.urlencode($myresult["statusMessage"]) . ': ' . MODULE_PAYMENT_LINKPOINTMS1_TEXT_ERROR_MESSAGE . ': ' . LINKPOINTMS1_ERROR_MESSAGE);
	exit;
      }
    }
