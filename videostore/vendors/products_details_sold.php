	          ...
	          <tr>
	            ...
	            <tr>
					<td colspan=6 width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
					  <tr><td class="pageHeading1" colspan=6>SOLD PRODUCTS INFORMATION</td></tr>
					</table>
					</td>
      			</tr>
				<tr>
		             ...
		             <tr>
		                <td colspan="9"><table border="0" width="100%" cellspacing="0" cellpadding="2">
		                  <tr>
		                    ...
		                    <td class="main" align="right" class="smalltext"><?php echo $orders_split->display_links($orders_query_count, 100, 10, $HTTP_GET_VARS['page'], tep_get_all_get_params(array('page', 'oID', 'action'))); ?></td>
		                  </tr>
		                </table></td>
	              	</tr>
					<tr class="dataTableHeadingRow">
						<td class="dataTableHeadingContent" align="left" width="6%"><?php echo TXT_ORDER_ID; ?>&nbsp;</td>
						<td class="dataTableHeadingContent" align="left" width="44%"><?php echo TXT_PRODUCT_NAME; ?>&nbsp;</td>
						...
						<td class="dataTableHeadingContent" align="left" width="20%"><?php echo TXT_SELLING_TYPE; ?></td>
					</tr>
<?
...
if ($products_fetch['products_item_cost']!=0)
...
if ($products_fetch['products_sale_type']==2) echo 'Consignment';
...
$total_vendor_cost_price = $total_vendor_cost_price+($products_fetch['products_item_cost']*$products_fetch['products_quantity']);
					...
					echo "<tr><td colspan=8 align=left class=main><b>Total Orders: ".tep_draw_separator('pixel_trans.gif', 45, '10').$total_qty_sold."</td></tr>";
					...
					echo "<tr><td></td></tr>";
if ($_GET['type']==1) $type = 'Direct Purchase';
elseif($_GET['type']==2) $type = 'Consignment';
else $type = 'Royalty';

$total_pay = tep_db_fetch_array(tep_db_query("SELECT sum(payment) AS sum FROM `vendor_payments` WHERE vendor_id=".$_SESSION['vendors_id']." and status='active' and  type='".$type."'"));
					...
					echo "<tr><td></td></tr>";
$total = tep_db_fetch_array(tep_db_query("SELECT sum(products_item_cost*products_quantity) as sum FROM orders_products op, products_to_vendors pv, orders o, products_description pd WHERE o.orders_id = op.orders_id AND pd.products_id = pv.products_id AND op.products_id = pv.products_id AND pv.vendors_id =".$_SESSION['vendors_id']." and pv.vendors_product_payment_type='".$_GET[type]."' ORDER  BY o.date_purchased DESC"));
$final = $total_vendor_cost_price-$total_pay[sum];
