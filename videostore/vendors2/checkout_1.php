...
if (!is_object($cart)){
    header('Location: https://www.travelvideostore.com/vendors/distribution.php?error=Shopping cart is empty');
	exit;
}
...
//if ( ( is_array($payment_modules->modules) && (sizeof($payment_modules->modules) > 1) && !is_object($$payment) ) || (is_object($$payment) && ($$payment->enabled == false)) ) {
    ...
    header('Location: https://www.travelvideostore.com/vendors/distribution.php?error_message=' . urlencode(ERROR_NO_PAYMENT_MODULE_SELECTED));
    exit;
  }
...
if ($_SESSION['vendor']['pickup']=='T'){
	...
	header('Location: https://www.travelvideostore.com/vendors/checkout_2.php');
	exit;
}
...
<!-- body_text //-->
    <td width="100%" valign="top"><form name="checkout_address" action="https://www.travelvideostore.com/vendors/checkout_1.php" method="post"><?php echo tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
