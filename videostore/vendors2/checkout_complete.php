...
// purchaseorders_1_4 end
  ...
  tep_mail($order->customer['firstname'] . ' ' . $order->customer['lastname'], $order->customer['email_address'], EMAIL_TEXT_SUBJECT, $email_order_old.$email_order, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);
...
// unregister session variables used during checkout
 ...
 // tep_redirect(tep_href_link(FILENAME_CHECKOUT_SUCCESS, '', 'SSL'));
    header('Location: https://www.travelvideostore.com/vendors/checkout_success.php');
