...
###########    
 ...
 #               echo "<BR> Using PHP curl methods <BR>";
            ...
            $result = curl_exec ($ch);
//$fp = fopen("curl.txt", "a+");
//fputs($fp, "=========='".$key."'========='".$xml."'========'".$host."'");
//fclose($fp);
/*mail('dkt@domo.net.ua','CURL Error', "=========='".$key."'========='".$xml."'========'".$host."'");*/
        ...
        {
/*	    
	    $xmlout = addslashes($xml);	
	    $body = '<table width="800" border="1"><tr><td>'.htmlspecialchars($xml).'</td></tr></table>';
	    $body .= "<br/><br/><b>Reason:</b> ".curl_error($ch)." - ".curl_errno($ch);
	    $body .= "<br/><br/><b>Returned value:</b> ".$result;

		$headers  = "MIME-Version: 1.0\r\n";
		$headers .= "Content-type: text/html; charset=iso-8859-1\r\n";
		$headers .= "From: Transaction service\r\n";
		$headers .= "To: ‘redit‘ardReceipt <creditcardreceipt@travelvideostore.com>\r\n";
	    mail('x0661t@d-net.kiev.ua','Transaction Error', $body, $headers);
	    mail('creditcardreceipt@travelvideostore.com','Transaction Error', $body, $headers);
*/
