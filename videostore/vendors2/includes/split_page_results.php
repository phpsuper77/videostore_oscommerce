...
// calculate number of pages needing links
      ...
      if ($num_pages > 1) {
        ...
        if ($current_page_number > 1) {
          //$display_links .= '<a href="' . tep_href_link('vendor/vendor_order_products_all.php', $parameters . $page_name . '=' . ($current_page_number - 1), 'NONSSL') . '" class="splitPageLink">' . PREVNEXT_BUTTON_PREV . '</a>&nbsp;&nbsp;';
        } else {
		...
		$test = tep_draw_pull_down_menu($page_name, $pages_array, $current_page_number, 'onChange="this.form.submit();"');
        $display_links .= "page ";
        $display_links .= $test;
        $display_links .= " of $num_pages";
